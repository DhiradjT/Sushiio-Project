...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 02 nov 2022 om 21:19
...
INSERT INTO `client` (`id`, `name`, `lastname`, `mail`, `adress`, `zip`, `residence`) VALUES
(1, 'Dhiradj', 'Tangali', 'supra@mail.com', 'Zandvoort 12', '2398AH', 'Zuid-Holland'),
(2, 'wwww', '', '', '', '', ''),
(3, 'Gurinder', 'Singh', 'gurinder@singh.com', 'Delhimarket 409', '3342 AZE', 'India'),
(4, 'ww', 'www', 'wwwwww@mail.com', 'wwww', 'www', 'www');
